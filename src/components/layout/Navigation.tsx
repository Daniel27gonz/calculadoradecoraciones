...
export function Navigation() {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-card/95 backdrop-blur-lg border-t border-border shadow-elevated md:top-6 md:bottom-auto md:border-t-0 md:border-b">
