...
import { Home, Calculator, Package, History, Settings, User, Wallet, Calendar, LogOut, Menu, X, ChevronRight, FilePlus, PackageOpen, Droplets, Wrench, FileText, Database } from 'lucide-react';
...
{ path: '/design', icon: FileText, label: 'Cotización (PDF)' },
